...
if __name__ == "__main__":
    ...
    # A = GoBoard((19,19))
    # A.place_stone_at((2,3));
    # # print(A.block_id_to_stone_block_hashmap, A.block_id_to_block_liberty_and_block_eye_hashmap)
    # # print(A)
    # A.place_stone_at((2,2));
    # # print(A.block_id_to_stone_block_hashmap, A.block_id_to_block_liberty_and_block_eye_hashmap)
    # # print(A)
    # A.place_stone_at((15,4));
    # # print(A.block_id_to_stone_block_hashmap, A.block_id_to_block_liberty_and_block_eye_hashmap)
    # # print(A)
    # A.place_stone_at((3,3));
    # # print(A.block_id_to_stone_block_hashmap, A.block_id_to_block_liberty_and_block_eye_hashmap)
    # # print(A)
    # A.place_stone_at((15,15));
    # # print(A.block_id_to_stone_block_hashmap, A.block_id_to_block_liberty_and_block_eye_hashmap)
    # # print(A)
    # A.place_stone_at((2,4));
    # # print(A.block_id_to_stone_block_hashmap, A.block_id_to_block_liberty_and_block_eye_hashmap)
    # # print(A)    
    # A.place_stone_at((2,14));
    # # print(A.block_id_to_stone_block_hashmap, A.block_id_to_block_liberty_and_block_eye_hashmap)
    # # print(A)
    # A.place_stone_at((1,3));
    # # print(A.block_id_to_stone_block_hashmap, A.block_id_to_block_liberty_and_block_eye_hashmap)
    # # print(A)
    # A.place_stone_at((2,3)) # self-suicide
